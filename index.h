...
<head>
    ...
    <style>
        ...
        #animation_list::-webkit-scrollbar {
            width: 5px;
            margin-left: 4px;
        }

        #animation_list::-webkit-scrollbar-track {
            background-color: #b6b6b642;
            border-radius: 10px;
        }

        #animation_list::-webkit-scrollbar-thumb {
            border-radius: 10px;
    ...
    <div class="main_panel">
        <div class="container">
            <section id="colorSelection">
                ...
                <div>
                    ...
                    <input type="color" oninput="changeColorInput_BGColor(this)" onchange="setColor('prim', this.value)"
                        id="prim_c" value="#CD1400">
                </div>
                <div>
        ...
        <div class="container">
            ...
            <span>
                ...
                <input id="anim_speedinput" type="range" min="0" max="10" oninput="adjustinputRange(this, 'anim')"
                    onchange="sendAnimationSpeed(this.value)">
            </span>
        </div>
    </div>
